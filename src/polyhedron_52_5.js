...
class Polyhedron_52_5 extends App {
  constructor(props) {
    ...
    this.state.content = (
        ...
        <div className = "figure-div">
        <figure>
            <img src = {require('./images/SmallStellatedDodecahedron/edge_exploded_SmallStellatedDodecahedron.gif')} alt = 'static'/>
    ...
    this.state.contentHeader = (<span>Small stellated dodecahedron {'{'}5/2, 5{'}'}</span>);
  }
}
